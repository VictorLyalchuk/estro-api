     ...
     new List<CategoryEntity>() {
        ...
        public static List<ProductSize> SeedSizes() =>
             new List<ProductSize>() {
                new ProductSize(){ Id = 1, Value = "35", Name_en = "35", Name_uk = "35", Name_es = "35", Name_fr = "35", InfoId = 3 },
                new ProductSize(){ Id = 2, Value = "36", Name_en = "36", Name_uk = "36", Name_es = "36", Name_fr = "36", InfoId = 3 },
                new ProductSize(){ Id = 3, Value = "37", Name_en = "37", Name_uk = "37", Name_es = "37", Name_fr = "37", InfoId = 3 },
                new ProductSize(){ Id = 4, Value = "38", Name_en = "38", Name_uk = "38", Name_es = "38", Name_fr = "38", InfoId = 3 },
                new ProductSize(){ Id = 5, Value = "39", Name_en = "39", Name_uk = "39", Name_es = "39", Name_fr = "39", InfoId = 3 },
                new ProductSize(){ Id = 6, Value = "40", Name_en = "40", Name_uk = "40", Name_es = "40", Name_fr = "40", InfoId = 3 },
                new ProductSize(){ Id = 7, Value = "41", Name_en = "41", Name_uk = "41", Name_es = "41", Name_fr = "41", InfoId = 3 },
                new ProductSize(){ Id = 8, Value = "42", Name_en = "42", Name_uk = "42", Name_es = "42", Name_fr = "42", InfoId = 3 },
                new ProductSize(){ Id = 9, Value = "43", Name_en = "43", Name_uk = "43", Name_es = "43", Name_fr = "43", InfoId = 3 },
                new ProductSize(){ Id = 10, Value = "44", Name_en = "44", Name_uk = "44", Name_es = "44", Name_fr = "44", InfoId = 3 },
                new ProductSize(){ Id = 11, Value = "45", Name_en = "45", Name_uk = "45", Name_es = "45", Name_fr = "45", InfoId = 3 },
                new ProductSize(){ Id = 12, Value = "46", Name_en = "46", Name_uk = "46", Name_es = "46", Name_fr = "46", InfoId = 3 },
            };
        public static List<ProductColors> SeedColors() =>
            new List<ProductColors>()
            {
                new ProductColors(){ Id = 1, Value = "black", Name_en = "Black", Name_uk = "Чорний", Name_es = "Negro", Name_fr = "Noir", InfoId = 1 },
                new ProductColors(){ Id = 2, Value = "blue", Name_en = "Blue", Name_uk = "Синій", Name_es = "Azul", Name_fr = "Bleu", InfoId = 1 },
                new ProductColors(){ Id = 3, Value = "brown", Name_en = "Brown", Name_uk = "Коричневий", Name_es = "Marrón", Name_fr = "Brun", InfoId = 1 },
                new ProductColors(){ Id = 4, Value = "burgundy", Name_en = "Burgundy", Name_uk = "Бордовий", Name_es = "Borgoña", Name_fr = "Bourgogne", InfoId = 1 },
                new ProductColors(){ Id = 5, Value = "gray", Name_en = "Gray", Name_uk = "Сірий", Name_es = "Gris", Name_fr = "Gris", InfoId = 1 },
                new ProductColors(){ Id = 6, Value = "lightgray", Name_en = "Light Gray", Name_uk = "Світло-сірий", Name_es = "Gris claro", Name_fr = "Gris clair", InfoId = 1 },
                new ProductColors(){ Id = 7, Value = "milk", Name_en = "Milk", Name_uk = "Молочний", Name_es = "Leche", Name_fr = "Lait", InfoId = 1 },
                new ProductColors(){ Id = 8, Value = "navi", Name_en = "Navi", Name_uk = "Наві", Name_es = "Navi", Name_fr = "Navi", InfoId = 1 },
                new ProductColors(){ Id = 9, Value = "white", Name_en = "White", Name_uk = "Білий", Name_es = "Blanco", Name_fr = "Blanche", InfoId = 1 },
            };
        ...
        new List<ProductEntity>() {
            new ProductEntity(){ Id = 1, Name = "Boots-stockings are black leather", Article = "ER00113828", ColorId = 1, MaterialId = 2, Description = "These stylish black leather boots-stockings are a perfect blend of fashion and comfort. Crafted with high-quality leather, they provide a sleek and sophisticated look. Ideal for various occasions, these boots-stockings are a must-have in your wardrobe.", SeasonId = 4, Price = 7399, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 2, Name = "Autumn brown leather stretch boots", Article = "ER00112019", ColorId = 3, MaterialId = 2, Description = "Step into the season with elegance in these Autumn brown leather stretch boots. Meticulously crafted from premium leather, these boots offer both style and comfort. The stretch feature ensures a snug fit, while the rich brown color adds a touch of warmth to your autumn wardrobe. Perfect for any occasion, these boots are a fashion statement that complements your unique style. Embrace the essence of autumn with each step.", SeasonId = 4, Price = 8899, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 3, Name = "Autumn leather stretch boots", Article = "ER00112018", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Black Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 black leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 8899, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 4, Name = "Boots autumn leather black", Article = "ER00112022", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Black Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 black leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 9899, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 5, Name = "Black autumn leather stretch boots", Article = "ER00112011", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Black Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 black leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 9899, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 6, Name = "Black demi-season boots", Article = "ER00113851", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Black Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 black leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 8799, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 7, Name = "Boots-stockings leather black", Article = "ER00112023", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Black Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 black leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 9989, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 8, Name = "Boots-pipes with wide freebies are burgundy", Article = "ER00114318", ColorId = 4, MaterialId = 2, Description = "Estro ER00112018 Burgundy Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 9989, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 9, Name = "Black leather Cossack boots", Article = "ER00112298", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Black Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 black leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 8799, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 10, Name = "Boots-stockings on a stiletto are black", Article = "ER00112123", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Black Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 black leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 8699, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 11, Name = "Milk stiletto stocking boots", Article = "ER00112122", ColorId = 7, MaterialId = 2, Description = "Estro ER00112018 Milk Leather Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 Milk leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 8699, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 12, Name = "Boots-stockings on a stiletto are brown", Article = "ER00114239", ColorId = 3, MaterialId = 2, Description = "Estro ER00112018 Milk Leather Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 Milk leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 8399, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 13, Name = "Boots-stockings on a stiletto are black", Article = "ER00114240", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Milk Leather Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 Milk leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 8399, CategoryId = 8, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 14, Name = "Ankle boots are black", Article = "ER00113949", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Milk Leather Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 Milk leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 4, Price = 2890, CategoryId = 7, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
            new ProductEntity(){ Id = 15, Name = "Winter boots", Article = "ER00111942", ColorId = 1, MaterialId = 2, Description = "Estro ER00112018 Milk Leather Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 Milk leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", SeasonId = 1, Price = 2290, CategoryId = 12, Details = "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", Highlights = ["Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton"] },
        };
