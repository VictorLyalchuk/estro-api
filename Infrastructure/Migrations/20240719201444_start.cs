        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Details_en = table.Column<string>(type: "text", nullable: false),
                    Details_uk = table.Column<string>(type: "text", nullable: false),
                    Details_es = table.Column<string>(type: "text", nullable: false),
                    Details_fr = table.Column<string>(type: "text", nullable: false),
                    Highlights_en = table.Column<List<string>>(type: "text[]", nullable: false),
                    Highlights_uk = table.Column<List<string>>(type: "text[]", nullable: false),
                    Highlights_es = table.Column<List<string>>(type: "text[]", nullable: false),
                    Highlights_fr = table.Column<List<string>>(type: "text[]", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Article", "CategoryId", "ColorId", "Description_en", "Description_es", "Description_fr", "Description_uk", "Details_en", "Details_es", "Details_fr", "Details_uk", "Highlights_en", "Highlights_es", "Highlights_fr", "Highlights_uk", "MaterialId", "Name_en", "Name_es", "Name_fr", "Name_uk", "Price", "SeasonId" },
                values: new object[,]
                {
                    { 1, "ER00113828", 8, 1, "These stylish black leather boots-stockings are a perfect blend of fashion and comfort. Crafted with high-quality leather, they provide a sleek and sophisticated look. Ideal for various occasions, these boots-stockings are a must-have in your wardrobe.", "Estas elegantes botas-medias de cuero negro son una combinación perfecta de moda y comodidad. Confeccionadas con cuero de alta calidad, brindan una apariencia elegante y sofisticada. Ideales para varias ocasiones, estas botas-medias son imprescindibles en tu guardarropa.", "Ces bottes-bas élégantes en cuir noir sont un mélange parfait de mode et de confort. Confectionnées dans un cuir de haute qualité, elles offrent un look élégant et sophistiqué. Idéales pour diverses occasions, ces bottes-bas sont un incontournable de votre garde-robe.", "Ці стильні чорні шкіряні чоботи-панчохи — це ідеальне поєднання моди та комфорту. Виготовлені з високоякісної шкіри, вони створюють елегантний і витончений вигляд. Ці чоботи-панчохи ідеально підходять для різних випадків, тому їх необхідно мати у вашому гардеробі.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Boots-stockings are black leather", "Las botas-medias son de cuero negro", "Les bottes-bas sont en cuir noir", "Чоботи-панчохи шкіряні чорного кольору", 7399m, 4 },
                    { 2, "ER00112019", 8, 3, "Step into the season with elegance in these Autumn brown leather stretch boots. Meticulously crafted from premium leather, these boots offer both style and comfort. The stretch feature ensures a snug fit, while the rich brown color adds a touch of warmth to your autumn wardrobe. Perfect for any occasion, these boots are a fashion statement that complements your unique style. Embrace the essence of autumn with each step.", "Entra en la temporada con elegancia con estas botas elásticas de cuero marrón Autumn. Meticulosamente elaboradas con cuero de primera calidad, estas botas ofrecen estilo y comodidad. La característica elástica garantiza un ajuste cómodo, mientras que el rico color marrón añade un toque de calidez a tu guardarropa de otoño. Perfectas para cualquier ocasión, estas botas son una declaración de moda que complementa tu estilo único. Abraza la esencia del otoño en cada paso.", "Entrez dans la saison avec élégance avec ces bottes stretch en cuir marron d'automne. Méticuleusement confectionnées à partir de cuir de première qualité, ces bottes offrent à la fois style et confort. La fonction extensible assure un ajustement parfait, tandis que la riche couleur marron ajoute une touche de chaleur à votre garde-robe d'automne. Parfaites pour toutes les occasions, ces bottes sont une déclaration de mode qui complète votre style unique. Embrassez l’essence de l’automne à chaque étape.", "Увійдіть у сезон з елегантністю в цих осінньо-коричневих шкіряних еластичних черевиках. Ретельно виготовлені з високоякісної шкіри, ці черевики пропонують стиль і комфорт. Еластична функція забезпечує щільне прилягання, а насичений коричневий колір додає нотку тепла у ваш осінній гардероб. Ідеально підходять для будь-якого випадку, ці черевики є модним виразом, який доповнює ваш унікальний стиль. З кожним кроком сприймайте сутність осені.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Autumn brown leather stretch boots", "Botas elásticas de piel marrón otoño", "Bottes stretch en cuir marron d'automne", "Осінні коричневі шкіряні еластичні черевики", 8899m, 4 },
                    { 3, "ER00112018", 8, 1, "Estro ER00112018 Black Leather Stretch Boots\r\n\r\nElevate your autumn style with the Estro ER00112018 black leather stretch boots. Crafted with a blend of high-quality leather and stretch material, these boots seamlessly marry fashion and comfort. The stretch element provides elasticity, ensuring a snug and flexible fit for easy wear. The sleek black color adds versatility, allowing for effortless pairing with various outfit styles.", "Estro ER00112018 Botas elásticas de cuero negro\r\n\r\nEleva tu estilo otoñal con las botas elásticas de cuero negro Estro ER00112018. Confeccionadas con una mezcla de cuero de alta calidad y material elástico, estas botas combinan a la perfección moda y comodidad. El elemento elástico proporciona elasticidad, lo que garantiza un ajuste ceñido y flexible para facilitar su uso. El elegante color negro añade versatilidad y permite combinarlo sin esfuerzo con varios estilos de vestimenta.", "Estro ER00112018 Bottes stretch en cuir noir\\r\\n\\r\\nÉlevez votre style automnal avec les bottes Estro ER00112018 en cuir stretch noir. Fabriquées avec un mélange de cuir de haute qualité et de matériaux extensibles, ces bottes allient harmonieusement mode et confort. L'élément extensible offre de l'élasticité, assurant un ajustement serré et flexible pour un port facile. La couleur noire élégante ajoute de la polyvalence, permettant une association sans effort avec différents styles de tenues.", "Чорні еластичні шкіряні черевики Estro ER00112018\r\n\r\nПокращіть свій осінній стиль за допомогою чорних еластичних шкіряних черевиків Estro ER00112018. Виготовлені із суміші високоякісної шкіри та еластичного матеріалу, ці черевики ідеально поєднують моду та комфорт. Стрейчовий елемент забезпечує еластичність, забезпечуючи щільне та гнучке прилягання для легкого носіння. Гладкий чорний колір додає універсальності, дозволяючи легко поєднувати з різними стилями одягу.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Autumn leather stretch boots", "Botas elásticas de piel de otoño", "Bottes d'automne en cuir stretch", "Чоботи осінні шкіряні стрейч", 8899m, 4 },
                    { 4, "ER00112022", 8, 1, "Demi-season boots of black color made of durable shoe leather will become reliable companions in all your adventures, travels, and beautiful companions for parties with friends. Stable heels in the shape of a trapezoid - not too high, and not too low. Seven centimeters of comfort and confidence in your walk. The grooved sole will protect against any inconvenience that may occur on the way - be it dirt, gravel, cobblestones or slippery surfaces. Nothing will prevent you from feeling confident.", "Las botas de entretiempo en color negro hechas de cuero duradero para zapatos se convertirán en compañeras confiables en todas tus aventuras, viajes y hermosas compañeras para fiestas con amigos. Tacones estables en forma de trapezoide, ni demasiado altos ni demasiado bajos. Siete centímetros de comodidad y confianza en tu caminar. La suela estriada protegerá contra cualquier inconveniente que pueda surgir en el camino, ya sea tierra, grava, adoquines o superficies resbaladizas. Nada te impedirá sentirte seguro.", "Les bottes demi-saison de couleur noire en cuir de chaussure durable deviendront des compagnons fiables dans toutes vos aventures, voyages et de beaux compagnons pour les fêtes entre amis. Talons stables en forme de trapèze – ni trop hauts ni trop bas. Sept centimètres de confort et de confiance dans votre marche. La semelle rainurée protégera contre tous les désagréments pouvant survenir sur le chemin, qu'il s'agisse de saleté, de graviers, de pavés ou de surfaces glissantes. Rien ne vous empêchera de vous sentir en confiance.", "Демісезонні ботфорти чорного кольору з міцної взуттєвої шкіри стануть надійними компаньйонами у всіх ваших авантюрах, подорожах, та красивими супутниками для вечірок з друзями. Стійкі підбори у формі трапеції — не дуже високі, і не занадто низькі. Сім сантиметрів зручності та впевненості у вашій ході. Рифлена підошва захистить від будь-яких незручностей, які траплятимуться на шляху — будь-то бруд, гравій, бруківка чи слизька поверхня. Ніщо не завадить почуватись впевнено.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Boots autumn leather black", "Botas otoño cuero negro", "Bottes automne cuir noir", "Чоботи осінні шкіряні чорні", 9899m, 4 },
                    { 5, "ER00112011", 8, 1, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Black autumn leather stretch boots", "Botas elásticas de piel de otoño negras", "Bottines stretch en cuir d'automne noires", "Чорні осінні шкіряні еластичні чоботи", 9899m, 4 },
                    { 6, "ER00113851", 8, 1, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Black demi-season boots", "Botas negras de entretiempo", "Bottes demi-saison noires", "Чорні демісезонні черевики", 8799m, 4 },
                    { 7, "ER00112023", 8, 1, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Boots-stockings leather black", "Botas-medias cuero negro", "Bottes-bas cuir noir", "Чоботи-панчохи шкіряні чорні", 9989m, 4 },
                    { 8, "ER00114318", 8, 4, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Boots-pipes with wide freebies are burgundy", "Las botas con pipas anchas son de color burdeos", "Les bottes-pipes avec de larges cadeaux sont bordeaux", "Черевики-дудочки з широкими халявами бордові", 9989m, 4 },
                    { 9, "ER00112298", 8, 1, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Black leather Cossack boots", "Botas cosacas de cuero negro", "Bottes cosaques en cuir noir", "Чорні шкіряні козацькі чоботи", 8799m, 4 },
                    { 10, "ER00112123", 8, 1, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Boots-stockings on a stiletto are black", "Las botas-medias con tacones de aguja son negras.", "Les bottes-bas sur un talon aiguille sont noires", "Чоботи-панчохи на шпильці чорні", 8699m, 4 },
                    { 11, "ER00112122", 8, 7, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Milk stiletto stocking boots", "Botas medias con tacón de aguja color leche", "Bottes bas à talons aiguilles au lait", "Чоботи панчохи на шпильці молочного кольору", 8699m, 4 },
                    { 12, "ER00114239", 8, 3, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Boots-stockings on a stiletto are brown", "Las botas-medias con tacón de aguja son marrones", "Les bottes-bas sur un talon aiguille sont marron", "Чоботи-панчохи на шпильці коричневі", 8399m, 4 },
                    { 13, "ER00114240", 8, 1, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Boots-stockings on a stiletto are black", "Las botas-medias con tacón de aguja son negras", "Les bottes-bas sur un talon aiguille sont noires", "Чоботи-панчохи на шпильці чорні", 8399m, 4 },
                    { 14, "ER00113949", 7, 1, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Ankle boots are black", "Los botines son negros", "Les bottines sont noires", "Ботильйони чорні", 2890m, 4 },
                    { 15, "ER00111942", 12, 1, "The most relevant women's shoes this fall are low-cut casual boots. They perfectly fit an active lifestyle: long walks, meetings, trips to work and on business. The knee height guarantees you warmth and protection from the piercing autumn wind. Pleasant to the touch pile and genuine leather with a smooth shiny surface - a good tandem for exquisite boots. The tractor sole with a small stable ring guarantees comfort and ease when walking. The highlight of this pair is the through lock that runs from the back of the calf and wraps around the foot. It is incredibly comfortable to wear and fix the leg with such a long zipper.", "El calzado de mujer más relevante este otoño son las botas casual de caña baja. Se adaptan perfectamente a un estilo de vida activo: largos paseos, reuniones, viajes al trabajo y de negocios. La altura de la rodilla te garantiza calidez y protección contra el penetrante viento otoñal. Pelo agradable al tacto y cuero genuino con una superficie lisa y brillante: un buen tándem para botas exquisitas. La suela del tractor con un pequeño anillo estable garantiza comodidad y facilidad al caminar. Lo más destacado de este par es el cierre pasante que va desde la parte posterior de la pantorrilla y envuelve el pie. Es increíblemente cómodo de llevar y fijar la pierna con una cremallera tan larga.", "Les chaussures pour femmes les plus pertinentes cet automne sont les bottes basses décontractées. Ils s'adaptent parfaitement à un mode de vie actif : longues promenades, réunions, déplacements professionnels et professionnels. La hauteur des genoux vous garantit chaleur et protection contre le vent perçant de l'automne. Pile agréable au toucher et cuir véritable avec une surface lisse et brillante - un bon tandem pour des bottes exquises. La semelle du tracteur avec un petit anneau stable garantit confort et facilité de marche. Le point fort de cette paire est le verrou traversant qui part de l'arrière du mollet et s'enroule autour du pied. Il est incroyablement confortable à porter et à fixer la jambe avec une fermeture éclair aussi longue.", "Найактуальніше жіноче взуття цієї осені — повсякденні ботфорти на низькому ходу. Вони ідеально пасують до активного стилю життя: тривалих прогулянок,  зустрічей, походів на роботу та у справах. Висота за коліно гарантує вам тепло і захищеність від пронизливого осіннього вітру. Приємний на дотик ворсин та натуральна шкіра з гладенькою блискучою поверхнею — гарний тандем для вишуканих ботфортів. Тракторна підошва з невеличким стійким каблучком гарантує зручність та легкість при ходьбі. Родзинка цієї пари — наскрізний замок, який йде ззаду від литки та загортається хвилькою по стопі. Неймовірно комфортно одягати та фіксувати ногу при такій довжині блискавки.", "The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: \"Black\". Need to add an extra pop of color to your outfit? Our white tee has you covered.", "El paquete de 6 camisetas básicas te permite expresar plenamente tu vibrante personalidad con tres opciones de escala de grises. ¿Te sientes aventurero? Ponte una camiseta gris jaspeado. ¿Quieres ser un creador de tendencias? Pruebe nuestra combinación de colores exclusiva: \"Negro\". ¿Necesitas agregar un toque extra de color a tu atuendo? Nuestra camiseta blanca lo tiene cubierto.", "Le Basic Tee 6-Pack vous permet d’exprimer pleinement votre personnalité vibrante avec trois options d’échelle de gris. Envie d'aventure ? Enfilez un t-shirt gris chiné. Vous voulez être un pionnier ? Essayez notre coloris exclusif : « Noir ». Besoin d'ajouter une touche de couleur supplémentaire à votre tenue ? Notre t-shirt blanc est là pour vous.", "Basic Tee 6-Pack дозволяє вам повністю виразити свою яскраву індивідуальність за допомогою трьох варіантів відтінків сірого. Почуття пригод? Одягніть сіро-вересову футболку. Хочете бути законодавцем моди? Спробуйте наш ексклюзивний колір: \"Чорний\". Хочете додати до свого вбрання яскравості? Наша біла футболка допоможе вам.", new List<string> { "Hand cut and sewn locally", "Dyed with our proprietary colors", "Pre-washed & pre-shrunk", "Ultra-soft 100% cotton" }, new List<string> { "Cortado y cosido a mano localmente", "Teñido con nuestros colores patentados", "Prelavado y preencogido", "Ultra suave 100% algodón" }, new List<string> { "Coupé et cousu à la main localement", "Teint avec nos couleurs exclusives", "Pré-lavé et pré-rétréci", "Ultra-doux 100% coton" }, new List<string> { "Вирізані вручну та зшиті на місці", "Пофарбовано в наші фірмові кольори", "Попереднє прання та усадка", "Надм’яка 100% бавовна" }, 2, "Winter boots", "Las botas de invierno son negras", "Bottes d'hiver", "Зимові черевики", 2290m, 1 }
                });
